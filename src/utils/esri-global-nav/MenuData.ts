...
import esriBrandLogoSvg from './img/gnav-esri-logo-globe-tm.svg';
import tsowFrame from './img/gnav-tsow-frame.svg'

const DEFAULT_MENU_DATA = {
	header: {
		theme: 'web',
		brand: {
			label: 'Lebanese Red Cross',
			image: esriBrandLogoSvg,
			href: 'https://www.redcross.org.lb/',
			width: 128,
			height: 30
		},
		menus: [
			[
					...
					menus: [
						{
							...
							href: 'https://gis.redcross.org.lb/emergency-response'
						},
						{
							label: 'Community Health',
							href: 'https://gis.redcross.org.lb/community-health'
						},
						{
							label: 'Logistics Management',
							href: 'https://gis.redcross.org.lb/logistics-management'
						},
						{
							label: 'Volunteer Coordination',
							href: 'https://gis.redcross.org.lb/volunteer-coordination'
						},
						{
							label: 'Mapping & Analysis',
							href: 'https://gis.redcross.org.lb/mapping-analysis'
						},
						{
							label: 'Data Visualization',
							href: 'https://gis.redcross.org.lb/data-visualization'
						},
						{
							label: 'Training & Support',
							href: 'https://gis.redcross.org.lb/training-support'
						},
						{
							label: 'Custom Solutions',
							href: 'https://gis.redcross.org.lb/custom-solutions'
						},
						{
							label: 'See all LRC GIS Services',
							href: 'https://gis.redcross.org.lb'
						}
					],
					tiles: [
						{
							label: 'Location Strategy',
							href: 'https://gis.redcross.org.lb/location-strategy',
							icon: [
						...
						},
						{
							...
							href: 'https://gis.redcross.org.lb/operational-intelligence',
							icon: [
						...
						{
							label: 'Resillient Communities',
							href: 'https://gis.redcross.org.lb/resilient-communities',
							icon: [
				...
				},
				{
					...
					menus: [
						{
							label: 'About Red Cross GIS',
							href: 'https://gis.redcross.org.lb/about-us'
						},
						{
							label: 'WhereNext',
							href: 'https://gis.redcross.org.lb/wherenext/'
						},
						{
							label: 'Newsroom',
							href: 'https://gis.redcross.org.lb/news'
						},
						{
							label: 'Events',
							href: 'https://gis.redcross.org.lb/events'
						},
						{
							label: 'Partners',
							href: 'https://gis.redcross.org.lb/partners'
						},
						{
							label: 'Volunteer',
							href: 'https://gis.redcross.org.lb/volunteer'
						},
						{
							label: 'Contact Us',
							href: 'https://gis.redcross.org.lb/contact-us'
						}
					],
					tiles: [
						{
							label: 'Academy',
							href: 'https://gis.redcross.org.lb/academy',
							icon: [
						...
						},
						{
							...
							href: 'https://gis.redcross.org.lb/development',
							icon: [
						...
						},
						{
							...
							href: 'https://www.redcross.org.lb/about-us',
							icon: [
					...
					menus: [
						{
							...
							href: 'https://support.gis.redcross.org.lb/'
						},
						{
							label: 'Training',
							href: 'https://gis.redcross.org.lb/training'
						},
						{
							label: 'Documentation',
		...
		account: {
			...
			menus: [
				...
				{
					label: 'Training',
					href: "http://pro.arcgis.com/en/pro-app/help/projects/living-atlas.htm"
				},
				{
	...
	footer: {
				...
				},
				{
					...
					menu: [
						...
						},
						{
							...
							href: 'https://gis.redcross.org.lb/disaster-mapping'
						},
						{
							label: 'Shelter Allocation',
							href: 'https://gis.redcross.org.lb/shelter-allocation'
						},
						{
							label: 'Supply Chain Tracking',
							href: 'https://gis.redcross.org.lb/supply-chain-tracking'
						},
						{
							label: 'Risk Assessment',
							href: 'https://gis.redcross.org.lb/risk-assessment'
						},
						{
							label: 'Field Reporting',
							href: 'https://gis.redcross.org.lb/field-reporting'
						},
						{
							label: 'Mobile Data Collection',
							href: 'https://gis.redcross.org.lb/mobile-data-collection'
						}
					]
				}
			]
		...
		social: {
			...
			menu: [
				{
					label: 'Facebook',
					href: 'https://www.facebook.com/LebaneseRedCross',
					image: {
						viewBox: '0 0 38 38',
				...
				{
					label: 'Twitter',
					href: 'https://x.com/RedCrossLebanon',
					image: {
						viewBox: '0 0 512 512',
				...
				{
					label: 'LinkedIn',
					href: 'https://www.linkedin.com/company/lebanese-red-cross',
					image: {
						viewBox: '0 0 24 24',
				...
				{
					label: 'Instagram',
					href: 'https://www.instagram.com/LebaneseRedCross',
					image: {
						viewBox: '0 0 30 30',
				...
				{
					label: 'YouTube',
					href: 'https://www.youtube.com/c/LebaneseRedCross',
					image: {
						viewBox: '0 0 310 310',
				...
				{
					label: 'GeoNet',
					href: 'https://www.redcross.org.lb/get-in-touch',
					image: {
						viewBox: '7 7 16 16',
		...
		info: {
			...
			menu: [
				{
					label: 'Privacy',
					href: 'https://www.redcross.org.lb/privacy-policy/'
				},
				// {
				// 	label: 'Legal',
				...
				},
				{
					...
					href: 'https://www.redcross.org.lb/wp-content/uploads/2023/09/Lebanese-Red-Cross-Code-of-Conduct.pdf'
				}
			]
        }
    }
...
export default DEFAULT_MENU_DATA;